...
$traceroute_to='r01krypta.bb.funkfeuer.at';     // defines destination for traceroute -> should be internet gateway
$traceroute6_to='r01krypta.bb.funkfeuer.at';    // defines destination for traceroute6 -> should be internet gateway
